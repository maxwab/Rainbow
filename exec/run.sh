...
#SBATCH --array=1-20%1                                  # Run a 20-job array, one job at a time.

# 0. Create env variables/ Code will run for 10 days.
